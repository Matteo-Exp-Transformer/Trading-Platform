...
**Context da creare prima:** `CHAT_ANALISI_CONTEXT.md`, `SIDEBAR_STORICO_CONTEXT.md`, `DB_SUPABASE_SKILL.md`.
**Fatto quando:** creo una chat, scrivo, ricarico e la ritrovo nello storico.

## M3 — Innesto del cervello + TEST VISTA  ⬜  *(deep — LOCK kit/catena agente)*
...
**Deliverable:** adapter Gemini in `providerClient`, modello da `.env`, prima analisi end-to-end.
**Context/area da creare prima:** `AGENTE_AI_SKILL.md`; **portare il kit v3** (`kit/Trade_Analysis_Agent_Kit_v3_1_.md`)
e splittarlo nei file caricabili `kit/01,02,04,06,07,08,09` (sostituendo i placeholder). **Fatto quando:** carico un
grafico e l'analisi è in stile Aware Trader, coerente con lo screenshot; esito test vista documentato.
